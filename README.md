...
The Arcade game focuses on dynamic player control, enemy interactions, and progressive difficulty through stage systems. The Village is not set up yet (only design and a few animation).
